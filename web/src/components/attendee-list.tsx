        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/10">
              <th
                style={{ width: 48 }}
                className="py-3 px-4 tex-sm font-semibold text-left"
              >
                <input
                  type="checkbox"
              ...
              <th className="py-3 px-4 tex-sm font-semibold text-left">
                Código
              </th>
              <th className="py-3 px-4 tex-sm font-semibold text-left">
                Participante
            ...
            {Array.from({ length: 4 }).map((_, i) => {
              return (
                ...
                >
                  ...
                  <td className="py-3 px-4 tex-sm text-zinc-300">12313</td>
                  <td className="py-3 px-4 tex-sm text-zinc-300">
          ...
          <tfoot>
            <tr>
              ...
              <td
                className="py-3 px-4 tex-sm text-zinc-300 text-right"
                colSpan={3}
              >
